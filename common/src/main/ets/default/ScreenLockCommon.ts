...
export function ConvertLunarCalendar(sy, sm, sd) {
  let lunarYearArr = [
    0x0b557,
  ...
  function ConvertLunarCalendar(sy, sm, sd) {
    sm -= 1;
    ...
    ly = getHeavenlyStemsAnd(ly) + getEarthlyBranches(ly);
    if (ld < 11) {
